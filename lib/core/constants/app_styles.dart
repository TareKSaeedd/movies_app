...
class AppStyles {
  ...
  static TextStyle robotoMedium16White = GoogleFonts.roboto(
    fontSize: 16,
    fontWeight: FontWeight.w400,
    color: AppColors.whiteColor,
  );

  static TextStyle robotoMedium15White = GoogleFonts.roboto(
    fontSize: 15,
    fontWeight: FontWeight.w400,
    color: AppColors.whiteColor,
  );
  ...
  static TextStyle interRegular20White2 = GoogleFonts.inter(
    fontSize: 20,
    fontWeight: FontWeight.w400,
    color: AppColors.whiteColor,
  );

  static TextStyle interSemiBoldBlack = GoogleFonts.inter(
    fontWeight: FontWeight.w600,
    color: AppColors.blackColor,
  );

  static TextStyle interSemiBoldYellow = GoogleFonts.inter(
    fontWeight: FontWeight.w600,
    color: AppColors.yellowColor,
  );
}
