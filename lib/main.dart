...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<LanguageCubit,LanguageState>(
      ...
      final locale=state is LanguageChanged ? state.locale : state is LanguageInitial
          ? state.locale
          : const Locale('en');
      return MaterialApp   (
        ...
        routes: {
          ...
          AppRoutes.updateProfileRouteName: (context) => UpdateProfilePage(), // todo : done localization
