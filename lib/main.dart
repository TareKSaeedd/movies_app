...
import 'package:movies_app/features/home/presentation/pages/tabs/movie_details_tab/movie_details_tab.dart';
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        ...
        AppRoutes.movieDetailsRouteName: (context) => MovieDetailsTab(),
