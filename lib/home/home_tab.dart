...
import 'package:movies_app/home/cubit/home_tab_states.dart';
import 'package:movies_app/home/cubit/home_tab_view_model.dart';
import 'package:movies_app/home/widgets/movie_item.dart';
                        ...
                        children: [
                              ...
                              child: CarouselSlider(
                                options: CarouselOptions(
                                  ...
                                  onPageChanged: (index, reason) {
                                    viewModel.changeSelectedIndex(index: index, moviesList: state.moviesList);
                                  },
                                ),
                                        ...
                                        child: Stack(
                                          children: [
                                            ClipRRect(
                                              borderRadius: BorderRadius.circular(20),
                                              child:
                                              generateCachedNetworkImage(key: ValueKey(state.selectedIndex),
                          ...
                          Positioned(
                              ...
                              generateRatingWidget(
                                width,height,state.moviesList[state.selectedIndex]!.rating.toString(),
                              )
                          )
                        ],
                      ),
...
CachedNetworkImage generateCachedNetworkImage({required ValueKey key,required String imageUrl,double? width,double?height}){
